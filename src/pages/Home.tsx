    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://drive.google.com/thumbnail?id=1afjUV0aEzf3zlZwwE_a9ASBtZuSmD4ux&sz=w2000" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <a href="https://intensiva.com.br/projetos/waterland/services/" className="btn-secondary !border-white !text-white hover:bg-white hover:text-brand-dark">
                {t('nav_services')}
              </a>
            </div>
          </motion.div>
      ...
      <section className="relative py-24 bg-[#ddf5ff] overflow-hidden">
